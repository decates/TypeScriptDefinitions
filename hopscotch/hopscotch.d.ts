...
declare module Hopscotch {
    ...
    export var hopscotch: Hopscotch;

    export interface HopscotchBubble {
    ...
    export interface HopscotchCalloutManager {
    ...
    export interface CalloutObject extends StepObject {
        id: string;
    }
}
